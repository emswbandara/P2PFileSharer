...
public class UDPProtocol {
    ...
    public static final String LOCAL_NODE_USERNAME = "node.username";
    public static final String BOOTSTRAPSERVER_IP = "bs.host";
    public static final String BOOTSTRAPSERVER_PORT = "bs.port";
}
